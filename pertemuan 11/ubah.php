...
<body>
    ...
    <input type="hidden" class="form-control" name="id" id="id" value="<?php echo $peliharaan["id"]; ?>">
  </div>       -->
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="gambar" id="gambar" value="<?php echo $peliharaan["gambar"]; ?>">
  </div>
